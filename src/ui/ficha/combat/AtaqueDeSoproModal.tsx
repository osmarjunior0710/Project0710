...
export default function AtaqueDeSoproModal({ cd, explicacaoCd, tipoDano, numDados, onRolarDano, onFechar }: AtaqueDeSoproModalProps) {
  return (
    <div className={styles.overlay} onClick={onFechar}>
      <div className={styles.card} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ fontSize: 26, fontWeight: 'bold', marginBottom: 12 }}>
          CD {cd ?? '—'} {explicacaoCd && <InfoValor titulo="Ataque de Sopro" explicacao={explicacaoCd} />}
        </div>
