...
export default function DescansoOverlay({
  ...
  return (
    <div className={styles.overlay} style={{ opacity: opaco ? 1 : 0, transitionDuration: `${duracao}ms` }}>
      ...
      ) : fase === 'perguntaRecuperacaoArcana' ? (
        <div className={styles.pergunta}>
          <div className={styles.texto}>Quer usar Recuperação Arcana (recuperar Espaços de Magia)?</div>
          <div className={styles.botoes}>
            <div className={styles.botao} onClick={() => onResponderRecuperacaoArcana(false)}>
              Não
            </div>
            <div
