...
export const talentos: Talento[] = [
  ...
  // Os 10 Estilos de Luta reais (categoria "Estilo de Luta") vivem só
  // em estilosDeLuta.ts, fonte de verdade usada por ataque.ts/
  // calculoPersonagem.ts/levelUp.ts. Essa categoria nunca é escolhida
  // como Talento (TelaEscolherTalento default é "Geral", nenhuma tela
  // passa categoria="Estilo de Luta") — cópia morta removida em 2026-09
  // pra eliminar risco de divergência entre os 2 arquivos.
  {
