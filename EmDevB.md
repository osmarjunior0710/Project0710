...
(nenhum foco em andamento — o último, "Saúde do projeto", fechou com
G1-G4 concluídos; ver `Changelog.md` v202609_1713/v202609_1737 pro
resumo, `DECISOES-DESIGN.md` pro padrão durável que ficou, e
`Backlog.md` pro que foi avaliado e adiado por prioridade)
